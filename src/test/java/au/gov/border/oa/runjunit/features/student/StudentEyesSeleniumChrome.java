...
public class StudentEyesSeleniumChrome {
    ...
    @Test
    public void viewStudyVisaDetailsSeleniumChrome() throws Exception {
...
//        js.executeScript("$('p.warning-text').removeClass('warning-text');");
    ...
    @Test
    public void viewPDFSeleniumChrome() {
        String pdfFile = System.getProperty("user.dir") + "\\src\\test\\resources\\pdf\\AppliTools POC - Baseline.pdf";
//        pdfFile = System.getProperty("user.dir") + "\\src\\test\\resources\\pdf\\AppliTools POC - Incorrect.pdf";
